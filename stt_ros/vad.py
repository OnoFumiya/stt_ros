...
class VadProcessor:
    def __init__(self, node: Node):
        ...
        self.vad_name = self.node.get_parameter_or('vad_name', RclpyParameter('vad_name', RclpyParameter.Type.STRING, 'ten_vad')).get_parameter_value().string_value
        self.hop_size = self.node.get_parameter_or('hop_size', RclpyParameter('hop_size', RclpyParameter.Type.INTEGER, 256)).get_parameter_value().integer_value
        self.threshold = self.node.get_parameter_or('threshold', RclpyParameter('threshold', RclpyParameter.Type.DOUBLE, 0.5)).get_parameter_value().double_value
